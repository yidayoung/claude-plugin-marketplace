...
export const createAntdTheme = (): ThemeConfig => ({
  ...
  components: {
    ...
    Button: {
      ...
      defaultHoverBg: 'var(--vscode-toolbar-hoverBackground)',
      defaultHoverColor: 'var(--vscode-foreground)',
      defaultHoverBorderColor: 'transparent',
      defaultActiveBg: 'var(--vscode-toolbar-hoverBackground)',
      defaultActiveColor: 'var(--vscode-foreground)',
