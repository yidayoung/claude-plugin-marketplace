...
export const BUILTIN_MARKETPLACES: BuiltinMarketplace[] = [
  ...
  },
  {
    ...
    description: '用于优化代码库打包和上下文管理的官方插件',
    descriptionEn: 'Official plugins for Repomix to optimize codebase packaging and context',
  ...
  // === 实验性市场 ===
  {
    ...
    name: 'thedotmack',
    displayName: 'Claude 跨会话记忆',
    displayNameEn: 'Claude Persistent Memory',
    description: '实验性功能：为 Claude Code 添加跨会话持久记忆，记住您的开发偏好',
    descriptionEn: 'Experimental: Adds persistent memory across sessions to remember developer preferences',
